...
function Node({
  ...
  const stroke = { default: "#2A3744", signal: "#F5B544", info: "#5B8DEF", warn: "#F5B544" }[tone];
  const labelColor = { default: "#E7EDF3", signal: "#F5B544", info: "#5B8DEF", warn: "#F5B544" }[tone];
  return (
  ...
  return (
    <div className="card overflow-x-auto p-5">
      ...
      <svg viewBox="0 0 1000 320" className="min-w-[860px]" role="img" aria-label="System request flow diagram">
        {/* Connection paths */}
        <FlowEdge d="M 190 139 C 240 139, 250 69, 280 69" color="#F5B544" animated dur="1.2s" />
        ...
        <FlowEdge d="M 740 209 H 800" color="#F5B544" animated dur="1.2s" />
